...
The core idea is that you are able to run one of the example projects to see it working against your BigInsights cluster. You can then copy the project to your environment and adapt it to add your own custom logic.  Think of the projects as working blueprints.
