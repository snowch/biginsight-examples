...
This example uses the Knox client librray to initiate a session on the BigInsights cluster and run mkdir to create a directory in HDFS.  After the directory is created, it is deleted.
