...
- Push data to Elasticsearch using Spark [[ElasticSearcIntegrationWithSpark](./ElasticSearcIntegrationWithSpark)] 
- Pull data from Elasticsearch to HDFS using Spark [[ElasticSearcIntegrationWithSpark](./ElasticSearcIntegrationWithSpark)] 
